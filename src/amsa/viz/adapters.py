...
def to_line_segments(
    ...
    *,
    ...
    return LineSegments(positions=pos, connect=connect, color=color, label=label)
...
def to_circle(
    ...
    *,
    ...
    """
    Create a Circle primitive for visualization.

    center: array of shape (2,) representing center coordinates.
    radius: float representing the circle radius.
    """
    return Circle(center=center, radius=radius, color=color, label=label)
