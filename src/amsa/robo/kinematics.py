...
if TYPE_CHECKING:
    from amsa.robo.model import Joint, RobotModel
...
def ik(*args: Any, **kwargs: Any) -> Any:
    ...
    if solver == "cga_sphere_sphere" and len(args) >= 2:
        from amsa.robo.geometry import sphere_sphere

        return sphere_sphere(args[0], args[1])
    if solver == "cga_point_circle" and len(args) >= 2:
        from amsa.robo.geometry import point_circle_projection
...
def motor_to_quaternion(motor: MVArray, alg: Algebra) -> np.ndarray:
    ...
    """
    from amsa.robo._validation import _validate_cga3d, _validate_motor_algebra
...
def joint_motion_motor(alg: Algebra, joint: Joint, value: float) -> MVArray:
    ...
    from amsa.robo.model import _joint_motion
...
def fk(
    ...
    *θ* is the variable; for prismatic joints *d* is the variable.
    ...
    """
    from amsa.robo._validation import _validate_cga3d, _validate_joint_types
...
def fk_model(
    ...
    """
    from amsa.robo._validation import _validate_cga3d
    from amsa.robo.model import _resolve_model_joint_values
...
def _model_fk_frames(
    ...
    from amsa.robo._validation import _validate_cga3d
    from amsa.robo.model import _joint_motion, _resolve_model_joint_values
...
def ik_dls(
    ...
    *,
    ...
    """
    from amsa.robo._validation import (
        _validate_cga3d,
        _validate_joint_types,
        _validate_motor_algebra,
    )
...
def ik_model_dls(
    ...
    *,
    ...
    from amsa.robo._validation import _validate_cga3d, _validate_motor_algebra
    from amsa.robo.model import active_joints
